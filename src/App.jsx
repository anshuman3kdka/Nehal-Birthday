      ...
      {links.map(({ to, label }) => {
        ...
        return (
          <Link
            ...
            className={`relative px-5 py-2 rounded-full transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(242,216,200,0.5)] focus-visible:bg-[rgba(141,99,123,0.1)] ${active ? 'text-[#f2d8c8]' : 'text-[rgba(245,245,247,0.5)] hover:text-[#f2d8c8]'}`}
          >
            {active && (
              <motion.div
                layoutId="navPill"
