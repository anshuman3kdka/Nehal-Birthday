      ...
      {links.map(({ to, label }) => {
        ...
        return (
          <Link
            ...
            className="relative px-5 py-2 rounded-full transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(242,216,200,0.5)]"
